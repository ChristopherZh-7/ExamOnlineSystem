<template>
  <div>
    <div style="margin-bottom: 10px">
      <h2 style="display: inline">部门信息</h2>
      ...
      >
        ...
        >
          <el-form-item label="部门" prop="majorName">
    ...
    >
      ...
      <el-table-column prop="majorName" label="部门"> </el-table-column>
      <el-table-column width="450">
        <template #header>
          <el-input v-model="search" placeholder="输入部门名称进行搜索" />
        </template>
    ...
    <el-dialog
      :title="dialogTableTitle + '部门' + dialogTableSubTitle"
