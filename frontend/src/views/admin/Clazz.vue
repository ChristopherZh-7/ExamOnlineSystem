<template>
  <div>
    <div style="margin-bottom: 10px">
      <h2 style="display: inline">小组信息</h2>
      ...
      >
        ...
        >
          <el-form-item label="部门" prop="majorId">
            <el-select
              filterable
              placeholder="请选择部门"
          ...
          <el-form-item label="小组" prop="clazzName">
    ...
    >
      ...
      <el-table-column prop="clazzName" label="小组"> </el-table-column>
      <el-table-column width="300">
        <template #header>
          <el-input v-model="search" placeholder="输入小组进行搜索" />
        </template>
    ...
    <el-dialog
      :title="dialogTableTitle + '小组所有学生信息'"
